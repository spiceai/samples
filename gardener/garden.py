...
class Garden:
    ...
    INITIAL_TIME_UNIX_SECONDS = 1609459200
    ...
    def update(self):
        ...
        is_afternoon = ((self.time_unix_seconds / Garden.STEP_INTERVAL_SECONDS) % Garden.STEPS_PER_DAY) > (Garden.STEPS_PER_DAY / 2)
        
        if is_afternoon and self.temperature < 99.9:
            self.temperature += 0.1
        elif not is_afternoon and self.temperature > 0.1:
            self.temperature -= 0.1
